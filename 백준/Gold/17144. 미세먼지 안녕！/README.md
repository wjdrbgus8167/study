...
### 문제 풀이 
<p> 1. spread 확산 함수 2. clockwise 시계방향, anticlockwise 반시계방향 이동 함수 3. 확산 후 값 저장 함수 arr_c -> 기존 함수와 합치기</p>

### 놓친 점
<p> 1. 확산된 미세먼지 값 저장 함수 선언 안한 것 2. 매초마다 확산되는 미세먼지 값에 대한 저장 함수 arr_c 초기화 안한 것 3. 공기청정기 좌표에 대한 설정 miss</p>
